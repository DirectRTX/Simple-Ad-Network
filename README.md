...
In the sections below, we're going to teach you about the Member's Area that publishers will be using and the Admin Dashboard which is where you can monitor everything.
